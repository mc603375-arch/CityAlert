    ...
    <div class="card">
                    ...
                    <tbody>
                        <?php foreach ($signalements as $sig): ?>
                            <tr>
                                ...
                                <td style="font-size:.82rem;color:var(--text-soft)"><?= htmlspecialchars($sig['categorie_libelle'] ?? $sig['categorie'] ?? '') ?></td>
                                <td>
        ...
        <?php else: ?>
            <div class="card-body" style="text-align:center;padding:3rem 1rem">
                ...
                <a href="<?= BASE_URL ?>/signalements/ajouter" class="btn btn-primary">Faire mon premier signalement</a>
            </div>
        <?php endif; ?>
    </div>
</div>
